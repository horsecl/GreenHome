...
2) Tecnologías usadas:
   ...
   CSS3 & Bootstrap 5: Maquetación responsiva, diseño adaptativo y estilos visuales.
   JavaScript (ES6+): Lógica del lado del cliente, manipulación del DOM, eventos e interacción con sensores.
